...
fatigue = UserMaxSTA
navn = UserName
frmInventory.Picture = LoadPicture(IniPath & "Grh\charsht.jpg")
...
Call DrawGrhtoHdc(frmInventory.ShowPic.hDC, CurrentGrh, 0, 0, 0, 0, SRCCOPY)
frmInventory.ShowPic.Picture = frmInventory.ShowPic.Image
