...
Label5 = "Takes you back to the Main Menu (logging off)"
End Sub

Private Sub Label3_Click()
On Error Resume Next
Call ButtonClick
'LLLLLLLLLAAAAAAAAAAAAAAAAAAMMMMMMMMMMMMMMMMMMMMMEEEEEEEE
'PL 11/22/2000
'frmMessage.message = "www.eraonline.net"
'frmMessage.Show

ShellExecute hWnd, vbNullString, "http://www.eraonline.net", vbNullString, App.Path, SW_SHOWNORMAL
...
'We wanna quit damnit, no t waste 5 seconds looking at... NOTHING
'PL 11/22/2000
'Dim PauseTime, Start, Finish, TotalTime
'
'   PauseTime = 0   ' Set duration.
