...
'This should take care of the 'Out of range' bug if
'the ini is inexistant
'PL 11/20/2000
...
On Error Resume Next
'check if loaded from the patcher
If (InStr(LCase(Command$), "--startedbypatcher") <= 0) Then End


'Rolph: Fake Fullscreen
...
'Set the version to a variable for later use
'PL 11/20/2000
MyVersion = App.Major & "." & App.Minor & " (Build #" & App.Revision & ")"
'*****************************************************************
'Main
'*****************************************************************
...
frmLoading.Show
'frmLoading.Picture = LoadPicture(IniPath & "Grh\loading.jpg")
frmLoading.loadstatus = "Setting up..."
'****** Init vars ******
IniPath = App.Path & "\"
ENDL = Chr(13) & Chr(10)
ENDC = Chr(1)
...
'frmLoading.Picture = LoadPicture(IniPath & "Grh\loading.jpg")
frmLoading.loadstatus = "Checking and setting up screen..."
'****** Check and setup screen ******

'Fixed the 'overflow' bug... the hdccaps and hdesktopwnd vars were supposed
'declared as long, not integer
'PL 11/20/2000
Call DesktopHandle
...
MsgBox "WARNING: This game should be run in 800x600 Screen Resolution and 16 Bits of color. Performance may slow down if not."
End If

'If bigger than 800x600 and 16 bit, terminate.

'I don't see why we are annoying users with a resolution > than 16
'afterall, isin't it better?
'PL 11/20/2000
'If DisplayWidth > 800 Or DisplayHeight > 600 Or DisplayBits > 16 Then

'If DisplayWidth > 800 Or DisplayHeight > 600 Then
'MsgBox "WARNING: This game should be run in 800x600 Screen Resolution and 16 Bits of color for optimal performance."
'End If

  'Download game address
  frmLoading.Inet.Url = "http://www.eraonline.net/patch/address.txt"
  Address = frmLoading.Inet.OpenURL(frmLoading.Inet.Url, icString)
    
'frmLoading.Picture = LoadPicture(IniPath & "Grh\loading.jpg")
frmLoading.loadstatus = "Loading graphic data..."
...
'****** Load files into memory ******
 Call LoadGrhData
'frmLoading.Picture = LoadPicture(IniPath & "Grh\loading.jpg")
frmLoading.loadstatus = "Loading Animation Data..."
Call LoadBodyData
'frmLoading.Picture = LoadPicture(IniPath & "Grh\loading.jpg")
frmLoading.loadstatus = "Loading Animation Data..."
...
'frmLoading.Picture = LoadPicture(IniPath & "Grh\load>ing.jpg")
Call LoadHeadData
Call LoadGraphics
'frmLoading.Picture = LoadPicture(IniPath & "Grh\loading.jpg")
'****** MidiPlayer INIT ******
...
'frmIntro_Part2.Show '<----Intro 'Movie'
frmMenu.Show
frmLoading.Hide
